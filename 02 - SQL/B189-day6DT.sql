...
--30-HAVING clause:GROUP BY komutundan sonra filtreleme için AGGREGATION fonk ile
--birlikte kullanılır
...
--31-UNION:iki farklı sorgunun sonucunu birleştirerek tek bir sütunda görüntülemeyi sağlar
