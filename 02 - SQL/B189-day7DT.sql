...
--NOT:INNER JOIN ortak kayıtları birleştirdiğinden tablo sırası önemli olmaz.
...
SELECT sirketler.sirket_id AS sirketler_id,
       sirket_isim,
	   siparis.sirket_id AS siparis_sirket_id,
...
--^:başlangıcını gösterir, $:bitişini gösterir
